...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.composer.status',
    kind: 'single',
    scope: 'session',
    summary: 'Thin persistent strip rendered just above the composer card.',
    doc: 'Thin persistent strip rendered just above the composer card.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'factory \'conversation.content\' (client-ui-conversation), so it exists while that definition is registered',
    occupants: [
      'client-ui-git-status GitStatusBar',
    ],
    replaceRisk: 'shadows-shipped-ui',
